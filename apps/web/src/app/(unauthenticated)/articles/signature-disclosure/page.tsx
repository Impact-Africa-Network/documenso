  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <h2>Welcome</h2>
        <p>
          Thank you for using Roots Africa to perform your electronic document signing. The purpose
        ...
        <p>
          By proceeding to use the electronic signature service provided by Roots Africa, you affirm
