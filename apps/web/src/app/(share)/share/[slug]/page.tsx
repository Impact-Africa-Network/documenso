...
export function generateMetadata({ params: { slug } }: SharePageProps) {
  return {
    title: 'Roots Africa - Share',
    description: 'I just signed a document in style with Roots Africa!',
    openGraph: {
      title: 'Roots Africa - Join the open source signing revolution',
      description: 'I just signed with Roots Africa!',
      type: 'website',
